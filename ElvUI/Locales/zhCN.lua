...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI已过期5个或者更多的版本。你可以在https://github.com/RosemyneH/ElvUI_Astral下载到最新的版本。"
L["ElvUI is out of date. You can download the newest version from https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI已过期。你可以在www.tukui.org下载到最新的版本。"
