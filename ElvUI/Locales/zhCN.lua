...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI已过期5个或者更多的版本。你可以在https://github.com/RosemyneH/ElvUI_Astral下载到最新的版本。"
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI已过期。你可以在www.tukui.org下载到最新的版本。"
...
L["For technical support visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "如需技术支援请至 https://github.com/RosemyneH/ElvUI_Astral."
L["Frame"] = "框架"
L["Friends List"] = "好友列表"
L["G"] = "公会"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "你已经完成安装过程. 如果你需要技术支持请访问https://github.com/RosemyneH/ElvUI_Astral"
