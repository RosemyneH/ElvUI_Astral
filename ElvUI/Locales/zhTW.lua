...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI 已過期超過5個版本. 你可以在 https://github.com/RosemyneH/ElvUI_Astral 下載到最新的版本."
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI 已過期. 你可以在 https://github.com/RosemyneH/ElvUI_Astral 下載到最新的版本."
...
L["For technical support visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "如需技術支援請至 https://github.com/RosemyneH/ElvUI_Astral."
L["Frame"] = "框架"
L["Friends List"] = "好友列表"
L["G"] = "公會"
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "鍵"
L["LOGIN_MSG"] = "歡迎使用 %sElvUI|r %s%s 版本|r, 輸入 /ec 可打開遊戲內設置介面. 如果你需要技術協助, 可訪問我們的網址 https://github.com/RosemyneH/ElvUI_Astral 或是加入我們的 Discord 伺服器: https://discord.gg/UXSc7nt"
L["Layout Set"] = "版面配置設定"
L["Layout"] = "介面佈局"
L["Left Chat"] = "左側對話框"
L["Left Click:"] = "滑鼠左鍵："
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "已完成安裝程序. 小提示: 若想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至https://github.com/RosemyneH/ElvUI_Astral"
