...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/RosemyneH/ElvUI_Astral"] = "현재 사용하는 ElvUI가 5버전 이상 뒤쳐진 버전입니다. https://github.com/RosemyneH/ElvUI_Astral 에서 새 버전을 다운로드 받으세요"
L["ElvUI is out of date. You can download the newest version from https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI가 오래된 버전입니다. https://github.com/RosemyneH/ElvUI_Astral 에서 새 버전을 다운로드 받으세요."
