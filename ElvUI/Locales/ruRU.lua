...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://github.com/RosemyneH/ElvUI_Astral"
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI устарел. Вы можете скачать последнюю версию с https://github.com/RosemyneH/ElvUI_Astral"
...
L["For technical support visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "За технической поддержкой обращайтесь на https://github.com/RosemyneH/ElvUI_Astral."
L["Frame"] = "Рамка"
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Клавиша"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/RosemyneH/ElvUI_Astral или присоединяйтесь к серверу Discord: https://discord.gg/UXSc7nt"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите сайт https://github.com/RosemyneH/ElvUI_Astral."
