...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI est périmé d'au moins 5 versions. Vous pouvez télécharger la nouvelle version sur https://github.com/RosemyneH/ElvUI_Astral"
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = "ElvUI est périmé. Vous pouvez télécharger la nouvelle version sur https://github.com/RosemyneH/ElvUI_Astral"
...
L["For technical support visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "Pour tout support technique, merci de nous rendre visite sur https://github.com/RosemyneH/ElvUI_Astral."
L["Frame"] = "Fenêtre"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/RosemyneH/ElvUI_Astral."] = "Vous avez maintenant terminé le processus d'installation. Si vous avez besoin d'un support technique, merci de vous rendre sur https://github.com/RosemyneH/ElvUI_Astral."
