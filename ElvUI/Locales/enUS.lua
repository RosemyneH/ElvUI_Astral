...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = true
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/RosemyneH/ElvUI_Astral"] = true
...
L["For technical support visit us at https://github.com/RosemyneH/ElvUI_Astral."] = true
L["Frame"] = true
L["Friends List"] = true
L["G"] = true
...
L["NAMEPLATE_NO_AWESOMEWOTLK"] = "AwesomeWotLK was not detected. Nameplates will use a limited fallback (target, mouseover, and group units only).\n\nGo to Discord #how-to-connect and install the lag fix. That also installs AwesomeWotLK if done correctly. You need Extensions/wxl-awesome-wotlk/wxl-awesome-wotlk.dll.\n\nAsk for more help in Discord if you still get this error."
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/RosemyneH/ElvUI_Astral."] = true
