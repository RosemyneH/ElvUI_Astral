...
S:AddCallbackForAddon("AscensionUI", "Skin_AscensionCharacter", function()
	if not E.private.skins.blizzard.enable or not E.private.skins.blizzard.character then return end
	if not _G.AscensionCharacterFrame or AscensionCharacterFrame.__elvSkinned then return end
	AscensionCharacterFrame.__elvSkinned = true
