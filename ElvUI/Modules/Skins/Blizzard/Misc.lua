...
S:AddCallback("Skin_Misc", function()
	...
	-- ESC/Menu Buttons
	if _G.EscapeMenu and _G.EscapeMenu.sections then
		EscapeMenu:StripTextures()
		EscapeMenu:CreateBackdrop("Transparent")
		if _G.EscapeMenuHeader then
	...
	elseif _G.GameMenuFrame then
		...
		local buttons = {
			...
			"GameMenuButtonMacOptions", "GameMenuButtonKeybindings", "GameMenuButtonMacros",
			"GameMenuButtonAddons", "GameMenuButtonElvUI", "GameMenuButtonLogout",
