...
E.PopupDialogs.ELVUI_UPDATE_AVAILABLE = {
	...
	OnShow = function(self)
		...
		self.editBox:SetText("https://github.com/RosemyneH/ElvUI_Astral")
	...
	EditBoxOnTextChanged = function(self)
		if self:GetText() ~= "https://github.com/RosemyneH/ElvUI_Astral" then
			self:SetText("https://github.com/RosemyneH/ElvUI_Astral")
		end
		self:HighlightText()
		self:ClearFocus()
		ChatEdit_FocusActiveWindow()
...
function E:StaticPopup_GetLastVisible()
	...
	if not lastFrame and WildCardUtil then
		if WildCardUtil.IsRapidRolling then
			lastFrame = not WildCardUtil.IsRapidRolling() and WildCardUtil.GetVisibleDice and WildCardUtil.GetVisibleDice()
		elseif WildCardUtil.GetVisibleDice then
