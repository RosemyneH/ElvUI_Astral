...
function oUF:SpawnNamePlates(namePrefix, nameplateCallback, nameplateCVars)
	...
	-- ʕ •ᴥ•ʔ✿ NAME_PLATE_* / UNIT_FLAGS are not on stock 3.3.5a ✿ ʕ •ᴥ•ʔ
	pcall(eventHandler.RegisterEvent, eventHandler, 'NAME_PLATE_UNIT_ADDED')
	pcall(eventHandler.RegisterEvent, eventHandler, 'NAME_PLATE_UNIT_REMOVED')
