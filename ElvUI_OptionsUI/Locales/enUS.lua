...
L["Broadcast on Instance Reset"] = true
L["Will announce when instance is reset."] = true
...
L["Assist"] = true
L["Astral"] = true
L["ASTRAL_DESC"] = "Astral is the main feature set of this UI pack. Disable it here to turn off all Astral integrations at once, or fine-tune individual modules below."
L["ASTRAL_ENABLE_DESC"] = "Master toggle for all Astral features in this UI pack."
L["Enable Astral"] = true
L["ASTRAL_GM_ICON_DESC"] = "Replace the Blizzard GM chat icon with the Astral texture. World nametags show <GM> instead."
L["ASTRAL_MICRO_BUTTON_DESC"] = "Show the Project Astral hub button on the micro bar."
L["ASTRAL_PROJECT_NOTE"] = "Project Astral skins also require the Project Astral add-on skin to be enabled under AddOn Skins."
L["Project Astral"] = true
L["Astral Core"] = true
L["Astral GM Icon"] = true
L["Astral Hub Skin"] = true
L["Astral Table Skin"] = true
L["Astral Micro Button"] = true
L["Astral Minimap Button Skin"] = true
L["Astral Popup Skin"] = true
L["Astral Transmogrify Skin"] = true
...
L["Hover Highlight Style"] = true
L["Hover Highlight Color"] = true
L["Glow Border"] = true
L["Hover"] = true
...
L["Vehicle"] = true
L["Vendor Gray Detailed Report"] = "Detailed Report"
L["Print each gray item to chat as it is sold when auto vendoring."] = true
L["Vendor Grays"] = true
L["Version"] = true
